(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/Observable'), require('rxjs/add/observable/of'), require('rxjs/add/observable/empty'), require('rxjs/Subject'), require('rxjs/add/operator/debounceTime')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'rxjs/Observable', 'rxjs/add/observable/of', 'rxjs/add/observable/empty', 'rxjs/Subject', 'rxjs/add/operator/debounceTime'], factory) :
	(factory((global['ngx-echarts'] = {}),global.ng.core,global.Rx,global.Rx.Observable,global.Rx.Observable,global.Rx));
}(this, (function (exports,core,Observable,of,empty,Subject) { 'use strict';
...
var NgxEchartsDirective = (function () {
    ...
    function NgxEchartsDirective(el, _ngZone) {
        ...
        this._resize$ = new Subject.Subject();
    }
    /**
     * @return {?}
     */
